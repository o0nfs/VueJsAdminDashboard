<template>
  ...
  <!-- Date -->
    ...
    <el-table-column
      ...
      label="Status"
      width="100"
      :filters="[{ text: 'draft', value: 'draft' }, { text: 'published', value: 'published' }]"
    ...
    >
      <template >
        ...
        <el-button
          size="mini"
          @click="showEditDialog=true">Edit</el-button>
        <!-- Published btn -->
          <el-button
          size="mini"
          type="success"
          @click="showPublishDialog=true">Publish</el-button>
        <!-- Delete btn -->
        <el-button
          size="mini"
          type="danger"
          @click="showDeleteDialog=true">Delete</el-button>
      </template>
    </el-table-column>
  </el-table>
  
  <!-- Dialogs Of Each Pressed Button -->
    <ModalDialog :show="showEditDialog"
          :cancel="cancel"
          :confirm="confirm"
          title="Edite a task?"
